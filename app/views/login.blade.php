...
<head>
    <meta charset="utf-8" />
    <title>WiVert Dashboard | Login Page</title>
...
<div id="page-container" class="fade">
    ...
    <div class="login login-v2" data-pageload-addclass="animated fadeIn">
        ...
        <div class="login-header">
            <div class="brand">
                <span class="logo"></span> WiVert Dashboard
                <small>track your bussiness !</small>
            </div>
        </div>
        <!-- end brand -->
        ...
        <div class="login-content">
            ...
            @endif
            {{ Form::open(array('url' => 'login', 'class' => 'margin-bottom-0')) }}
            {{ $errors->first('email') }}
            ...
            <div class="login-buttons">
                {{ Form::button('Sign me in',array('type' => 'submit', 'class' => 'btn btn-success btn-block btn-lg', )) }}
            </div>
            {{ Form::close() }}
        </div>
    </div>
